...
dataset=data_import(audio_path,0)  # 0 for registered(known) people, 1 for unregistered(unknown)people
...
for name in dataset.keys():
	...
	for samples in single_data:
		...
		freq_frames=mel_func(window_frames)# output frames in frequency domain
